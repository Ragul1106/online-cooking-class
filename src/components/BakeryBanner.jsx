    ...
    return (
        <div>
            ...
            <div className="relative w-full max-w-7xl">
                ...
                <div className="absolute left-20 md:left-32 top-[20rem] md:top-[28rem] text-white font-bold  text-sm md:text-sm lg:text-lg z-10">
                ...
                onClick={() => navigate('/enroll')}
                 className="absolute left-20 md:left-56 lg:left-56 bottom-[220px] md:bottom-[160px] lg:bottom-32 z-20">
                    <img src={enrollNow} className="w-24 md:w-28 lg:w-48" alt="Enroll Now" />
                </button>
