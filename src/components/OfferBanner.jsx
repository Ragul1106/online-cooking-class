  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto my-10 rounded-2xl overflow-hidden shadow-xl">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-start px-6 md:px-12">
        ...
        <button className="absolute left-1/2 transform -translate-x-1/2 bottom-6 bg-[#D66567] hover:bg-[#bb4a4c] text-white font-semibold py-2 px-5 rounded-full transition duration-300">
    LEARN MORE
  </button>
      </div>
