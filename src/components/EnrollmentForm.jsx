...
const EnrollmentForm = () => {
    ...
    return (
        <div className="min-h-screen bg-[#fff7eb] flex items-center justify-center px-4 py-8">
            <div className="w-full max-w-7xl bg-[#fdeedc] rounded-xl shadow-md py-6 px-6 md:px-20 relative">
                ...
                <h2 className="text-center mt-8 mb-4 text-xl sm:text-2xl lg:text-3xl font-bold">
                    BAKERY BUSINESS <span className="font-normal">ACCELERATOR PROGRAM</span>
                </h2>

                <form className="space-y-5 text-sm md:text-base lg:text-2xl" onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 mb-6">
                        <div className="w-full sm:w-1/2 space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full shadow border rounded-2xl px-4 py-6"
                                />
                        ...
                        <div className="w-full sm:w-1/2 flex flex-col justify-center text-sm sm:text-base font-semibold space-y-3 pl-2">
                            {isNewAccount ? (
                                <>
                                    <button
                                        type="button"
                    ...
                    <div className="flex justify-between shadow items-center bg-white border rounded-2xl px-4 py-6 font-semibold">
                        <span>SUB TOTAL:</span>
                        <span>INR 36000</span>
                    </div>
                    ...
                    <div className="flex gap-4">
                        <input
                            ...
                            className="flex-grow border shadow rounded-2xl px-4 py-6"
                        />
                        <button
                            type="button"
                            onClick={handleApplyCoupon}
                            className="bg-white border shadow rounded-2xl px-4 py-6 font-semibold"
                        >
                            APPLY COUPON
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="rounded-2xl px-4 py-6 ">
                            ...
                            <button
                                type="button"
                                className={`w-full shadow  rounded-2xl px-4 py-6 ${paymentMethod === 'upi' ? 'bg-green-100 border-green-500' : 'bg-white'}`}
                        ...
                        <div className="rounded-2xl px-4 py-6 ">
                            ...
                            <button
                                type="button"
                                className={`w-full shadow rounded-2xl px-4 py-6 ${paymentMethod === 'card' ? 'bg-green-100 border-green-500' : 'bg-white'}`}
